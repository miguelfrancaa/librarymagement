...
@section('content')
	...
	<div class="container">
		<div class="row" style="height: 80vh;">
			...
			<div class="col-md-6 card h-50 mb-3 perfectCover border border-white border-5 rounded" style="background-image: url(/img/authorsadmin.png);"><a href="{{route('admin.authors.index')}}"><h2 class="position-absolute bottom-0 start-0 ms-3 mb-3 fw-bold text-dark"><button class="btn btn-light btn-lg">Admins</h2></button></a></div>
		</div>
	</div>
